...
namespace _2023
{
    public class Day01Tests
    {
        ...
        public void SingleStringShouldReturnCorrectResultsFromFirstStage(string input, string expectedResult)
        {
        ...
        [Fact]
        public void AllFromFirstStageReturnCorrectValue()
        {
        ...
        public void SingleStringShouldReturnCorrectResultsFromSecondStage(string input, string expectedResult)
        {
        ...
        [Fact]
        public void AllFromSecondStageReturnCorrectValue()
        {
            var input = new List<string>();
